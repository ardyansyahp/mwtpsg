...
@section('content')
<div class="fade-in px-6 py-6">
    {{-- Header & Toolbar --}}
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            <h2 class="text-3xl font-bold text-gray-800">Surat Perintah Pengiriman</h2>
            <p class="text-gray-600 mt-1">Manajemen SPK, Import/Export, dan Data Sampah</p>
        </div>
