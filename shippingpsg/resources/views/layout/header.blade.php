    ...
    <div class="flex items-center justify-between px-3 sm:px-6 py-2">
        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <div class="flex items-center gap-2">
                <h2 class="text-sm sm:text-base font-semibold text-gray-800 truncate max-w-[150px] sm:max-w-none">Shipping PSG</h2>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="flex items-center gap-2 cursor-pointer hover:bg-gray-50 rounded-lg px-3 py-2 transition-colors">
                    ...
                    <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center text-blue-700 text-sm font-semibold shadow-sm">
                        ...
                        <div class="mt-2.5">
                            ...
                            @else
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider bg-blue-100 text-blue-700 border border-blue-200">
                                    ...
                                    {{ session('departemen', 'LOGISTIC STAFF') }}
                                </span>
                            @endif
                        </div>
                    </div>
