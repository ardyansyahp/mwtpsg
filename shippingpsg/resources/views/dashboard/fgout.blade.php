...
<div class="p-6 space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
        <div>
            <h1 class="text-xl font-bold text-gray-900 leading-none">📤 Dashboard Finish Good Out</h1>
            <p class="text-[10px] text-gray-500 mt-1.5 uppercase font-bold tracking-wider">Monitoring hasil scan keluar (Pengiriman) per periode</p>
        </div>
        ...
        <div class="w-full md:w-auto flex flex-col md:flex-row gap-2">
            <form id="filterForm" class="flex flex-col md:flex-row gap-2">
                ...
                @if(request('part_id'))
                    <a href="{{ route('finishgood.out.dashboard') }}" class="bg-gray-100 text-gray-600 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors text-center">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
            ...
            Trend Pengiriman (30 Hari Terakhir)
        </h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function refreshData() {
        ...
        const url = `{{ route('finishgood.out.dashboard') }}?part_id=${partId}&ajax=1`;
