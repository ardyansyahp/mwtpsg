...
class ProfileController extends Controller
{
    ...
    public function edit()
    {
        ...
        $user = User::where('user_id', $userId)->with('manpower')->firstOrFail();
        
        // Check if user is Kabag or Management role
        if (!$user->isKabag() && $user->role !== 2) {
            abort(403, 'Access denied. Profile settings are only available for Kabag and Management users.');
        }
