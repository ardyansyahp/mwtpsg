...
class LoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if ($user && in_array($user->role, [1, 2])) {
            ...
            return $this->authenticated($request, $user) ?: redirect('/')->with('success', 'Welcome back!');
        }
        ...
        return $this->authenticated($request, $user) ?: redirect('/')->with('success', 'Welcome, ' . $manpower->nama . '!');
    }
