...
<div class="no-print" style="display:flex;gap:8px;align-items:center;justify-content:space-between;margin-bottom:12px;">
  <div>
    ...
    <div style="color:#555;font-size:12px;">
      ...
      PO: {{ $receiving->no_purchase_order ?? '-' }} |
  ...
  <div style="display:flex;gap:8px;">
    ...
    <button onclick="window.location.href='{{ route('bahanbaku.receiving.index') }}'" style="padding:8px 12px;border-radius:8px;border:1px solid #ddd;background:#f3f3f3;cursor:pointer;">Kembali ke Receiving</button>
  </div>
</div>
