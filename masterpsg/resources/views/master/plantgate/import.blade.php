...
<div class="fade-in">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-900 leading-none">Import Master Plant Gate</h2>
        <p class="text-[10px] text-gray-500 mt-1.5 uppercase font-bold tracking-wider">Import data plant gate dari file CSV dengan mapping kolom dinamis</p>
    </div>
