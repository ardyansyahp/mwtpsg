...
<div class="fade-in">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-900 leading-none">Hapus Perusahaan</h2>
        <p class="text-[10px] text-gray-500 mt-1.5 uppercase font-bold tracking-wider">Konfirmasi penghapusan data perusahaan</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-4">
                Data perusahaan <strong>{{ $perusahaan->nama_perusahaan }}</strong> akan dihapus secara permanen.
            </p>
            <div class="bg-gray-50 rounded-lg p-4 mb-4">
                <p class="text-sm text-gray-700"><strong>Nama Perusahaan:</strong> {{ $perusahaan->nama_perusahaan }}</p>
                @if($perusahaan->inisial_perusahaan)
                    <p class="text-sm text-gray-700 mt-1"><strong>Inisial:</strong> {{ $perusahaan->inisial_perusahaan }}</p>
                @endif
                @if($perusahaan->jenis_perusahaan)
                    <p class="text-sm text-gray-700 mt-1"><strong>Jenis:</strong> {{ $perusahaan->jenis_perusahaan }}</p>
                @endif
            </div>
