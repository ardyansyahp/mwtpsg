...
<head>
    ...
    @stack('styles')
    <style>
        /* Injected by Setup Script for Master PSG */
        /* Override Navbar/Header Background */
        header.bg-white { 
        ...
        header .text-gray-800, header .text-gray-700, header .text-gray-900 {
        ...
        /* Assuming we want to tint the sidebar too? Maybe better left white for contrast. */
        
        /* Change Page Title */
        title { content: "Master PSG"; }
    </style>
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const toggles = ['masterDataToggle', 'subMasterToggle', 'bahanBakuToggle', 'stockToggle', 'loadingToggle', 'shippingToggle', 'controlToggle', 'dashboardToggle'];
            toggles.forEach(id => {
