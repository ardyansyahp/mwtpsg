    ...
    <div class="flex items-center justify-between px-3 sm:px-6 py-2">
        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <div class="flex items-center gap-2">
                <h2 class="text-sm sm:text-base font-semibold text-gray-800 truncate max-w-[150px] sm:max-w-none">Master PSG</h2>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="flex items-center gap-2 cursor-pointer hover:bg-gray-50 rounded-lg px-3 py-2 transition-colors">
                    ...
                    <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center text-black text-sm font-semibold shadow-sm">
                ...
                <div x-show="open" 
                    ...
                    <div class="px-4 py-3 border-b border-gray-100">
                        ...
                        <div class="mt-2.5">
                            ...
                            @else
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider bg-blue-100 text-blue-700 border border-blue-200">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    {{ session('departemen', 'General Staff') }}
                                </span>
                            @endif
                        </div>
                    </div>
                    ...
                    {{-- Menu Items --}}
                    @if(session('is_superadmin'))
                        <a href="{{ route('superadmin.users.index') }}" class="flex items-center px-4 py-2 text-sm text-black hover:bg-gray-50 transition-colors">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="#000000" viewBox="0 0 24 24">
