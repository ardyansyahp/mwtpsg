...
<div class="fade-in">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-900 leading-none">Hapus Mold</h2>
        <p class="text-[10px] text-gray-500 mt-1.5 uppercase font-bold tracking-wider">Konfirmasi penghapusan data mold</p>
    </div>
