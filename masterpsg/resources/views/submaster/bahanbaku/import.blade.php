...
<div class="fade-in">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-xl font-bold text-gray-900 leading-none">Import Bahan Baku</h2>
            <p class="text-[10px] text-gray-500 mt-1.5 uppercase font-bold tracking-wider">Import data bahan baku dari file CSV dengan mapping kolom dinamis</p>
        </div>
        <a 
